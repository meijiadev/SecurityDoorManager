...
public class SrsCameraView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if(mSurfaceWidth != mPreviewWidth || mSurfaceHeight != mPreviewHeight){           
            ...
            Log.e("SrsCameraView", String.format("Surface dimensions differ from Preview. May be a buffer overflow. Surface: %dx%d, Preview: %dx%d ", mSurfaceWidth, mSurfaceHeight, mPreviewWidth, mPreviewHeight));
            return;
        }        
