...
import com.sjb.securitydoormanager.media.mqtt.mode.AlarmInfo
import com.sjb.securitydoormanager.media.mqtt.mode.DevRecord
import com.sjb.securitydoormanager.media.mqtt.mode.DeviceStatus
import com.sjb.securitydoormanager.media.mqtt.mode.MessageEvent
...
val TOPIC_SEND = "securityDoor/pub/SD00000004"


val TOPIC_MSG = "securityDoor/sub/SD00000004"
...
class MqttHelper {
    ...
    constructor(context: Context, serverUrl: String, name: String) {
        ...
        connectOptions.setWill(TOPIC_SEND, msg.toByteArray(), Qos.QOS_TWO.value(), false)
    }
...
//                    }
     ...
     * 上传安检记录
     */
    fun uploadRecord(passStatus: Int, passMode: String) {
