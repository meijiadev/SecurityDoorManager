...
package com.sjb.securitydoormanager.codec.language.bm;

import com.sjb.securitydoormanager.codec.language.bm.Languages.LanguageSet;
import com.sjb.securitydoormanager.codec.language.bm.Rule.Phoneme;
...
public class PhoneticEngine {
    ...
    static final class PhonemeBuilder {
        ...
        public String makeString() {
            return phonemes.stream().map(Phoneme::getPhonemeText).collect(Collectors.joining("|"));
        }
    }
    ...
    private PhonemeBuilder applyFinalRules(final PhonemeBuilder phonemeBuilder,
        ...
        final Map<Phoneme, Phoneme> phonemes = new TreeMap<>(Phoneme.COMPARATOR);
